------------------------------------------------------------------------------
--                                                                          --
--  This file is based on code from GNAT. The below terms below apply only  --
--  to this file. Refer to COPYING in the root directory for the terms for  --
--  other parts of Prunt.                                                   --
--                                                                          --
...
--  TODO: This is ported from GCC 16 and should be removed once GCC 16 is released.
...
private
   ...
   function Max_Allocation_Overhead_In_Storage_Elements return Storage_Count is
     (if Element_Type'Max_Size_In_Storage_Elements >= Storage_Count (Integer'Last)
        or else Element_Size_In_Storage_Elements >= Long_Integer (Integer'Last)
      then
...
end Bounded_Indefinite_Holders;
