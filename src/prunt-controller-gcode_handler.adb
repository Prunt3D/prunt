...
package body Prunt.Controller.Gcode_Handler is
   ...
   task body Runner is
      ...
      procedure Double_Tap_Home_Axis (Axis : Axis_Name; Current_Pos : in out Position) is
      ...
      procedure StallGuard_Home_Axis (Axis : Axis_Name; Current_Pos : in out Position) is
                  ...
                  begin
                     ...
                     case Axial_Homing_Params (Axis).Kind is
                        ...
                        when My_Config.StallGuard2_Kind | My_Config.StallGuard4_Kind =>
                           StallGuard_Home_Axis (Axis, Current_Pos);
                     ...
                     for R in TMC_Types.TMC2240.UART_Register_Address loop
                        declare
                           Query          : TMC_Types.TMC2240.UART_Query_Message :=
                             (Bytes_Mode => False,
                              Content    =>
                                (Node => Stepper_Hardware (S).TMC2240_UART_Address, Register => R, others => <>));
   ...
   protected body Finished_Block_Queue is
      ...
      entry Pop (Out_Data : out Flush_Resetting_Data; Out_First_Segment_Accel_Distance : out Length) when Has_Item is
      begin
         Out_Data := Data;
